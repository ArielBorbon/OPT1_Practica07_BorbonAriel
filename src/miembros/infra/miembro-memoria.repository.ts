...
export class MiembroMemoriaRepository implements MiembroRepository {
    private miembros: Miembro[] = [
        { id: 1, nombre: 'Ariel Borbón', correo: 'ariel.borbon@gmail.com', membresia: 'Mensual', activo: true },
        { id: 2, nombre: 'Juan Guillermo', correo: 'juan.guillermo@gmail.com', membresia: 'Anual', activo: true },
        { id: 3, nombre: 'Chuy Perez', correo: 'chuy.perez@gmail.com', membresia: 'Mensual', activo: false }
    ];
